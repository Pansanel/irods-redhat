...
BuildRequires:	perl, perl-Archive-Tar, libtool-ltdl-devel, globus-gss-assist-devel, globus-gssapi-gsi-devel, netcdf-devel, pam-devel, unixODBC-devel
...
%if 0%{?rhel} < 6
sed -i \
    -e 's/sk_GENERAL_NAMES/sk_GENERAL_NAME/' \
    lib/core/src/sslSockComm.c
%endif
make
make fuse
